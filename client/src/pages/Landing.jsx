...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f2f4f6] px-4 font-sans selection:bg-blue-100">
      <div className="w-full max-w-[400px] flex flex-col items-center">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-xs">© 2026 Jamie CMS. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
